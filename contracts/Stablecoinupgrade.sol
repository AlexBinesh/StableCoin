...
contract Stablecoinupgrade {
	bool NotInitialized = true;
    //ERC20 Required Variables
    string constant token_name = "Stablecoinupgrade Stable Coin";
...
//	function InitContract(uint256 total) public view returns (uint256) {
	function InitContract(uint256 total) external {
		require(NotInitialized, "StableCoinUpgrade Contract instance has already been initialized");
	...
	*/
	...
	function InitValue() public view returns (bool) {
...
//		require(false, "StableCoinUpgrade Contract balanceof Function==========");
